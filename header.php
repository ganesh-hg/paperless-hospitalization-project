...
<style>
input[type=submit]{
background-color: blue; /* Green */ border: none; 
cursor:pointer;
...
<body>
<div class="wrapper col1" style="background-color: #ffffff6e">
  <div id="head">
    
  <br>
    <center><h1>NewLife Hospital</h1></center>
    <div id="topnav" style="background-color: #3d73b1">
      <ul>
        <li><a  href="index.php" <?php if(basename($_SERVER['PHP_SELF']) == "index.php"){ echo ' class="active"'; } ?> >Home</a></li>
        <li><a  href="departments.php" <?php if(basename($_SERVER['PHP_SELF']) == "departments.php"){ echo ' class="active"'; } ?> >Departments</a></li>
